...
class ActivityPub::ProcessAccountService < BaseService
  ...
  def set_fetchable_attributes!
    ...
    rescue Mastodon::UnexpectedResponseError, HTTPX::TimeoutError, HTTPX::ConnectionError, OpenSSL::SSL::SSLError
  ...
  rescue HTTPX::Error, OpenSSL::SSL::SSLError, Mastodon::LengthValidationError
