...
class VerifyLinkService < BaseService
  def call(field)
    ...
    field.mark_verified!
  rescue OpenSSL::SSL::SSLError, HTTPX::Error, Addressable::URI::InvalidURIError, Mastodon::HostValidationError, Mastodon::LengthValidationError, IPAddr::AddressFamilyError => e
