...
class Api::V1::NotificationsController < Api::BaseController
  ...
  def browserable_params
    params
      .slice(:account_id, :include_filtered, :exclude_types, :types)
      .permit(:account_id, :include_filtered, exclude_types: [], types: [])
  end

  def pagination_params(core_params)
    params
      .slice(:limit, :account_id, :include_filtered, :exclude_types, :types)
      .permit(:limit, :account_id, :include_filtered, exclude_types: [], types: [])
      .merge(core_params)
  end
end
