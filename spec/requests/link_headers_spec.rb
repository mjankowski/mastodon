...
describe 'Link headers' do
  describe 'on the account show page' do
    ...
    it 'contains webfinger url in link header' do
      ...
      expect(link_header.href).to eq 'http://www.example.com/.well-known/webfinger?resource=acct%3Atest%40localhost%3A3000'
    ...
    it 'contains activitypub url in link header' do
      ...
      expect(link_header.href).to eq 'http://localhost:3000/users/test'
