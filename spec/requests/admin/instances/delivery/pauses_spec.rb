...
RSpec.describe 'Admin Instances Delivery Pauses' do
  ...
  describe 'DELETE /admin/instances/:instance_id/delivery/pause' do
  ...
  describe 'POST /admin/instances/:instance_id/delivery/pause' do
    subject { post admin_instance_delivery_pause_path(account_popular_main.domain) }

    it 'marks the domain as unavailable to pause delivery and logs action' do
      expect { subject }
