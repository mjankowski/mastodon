...
RSpec.describe Account do
  ...
  describe '#prefixed_pretty_acct' do
    context 'with a local account' do
      let(:account) { Fabricate.build :account, username: 'username' }

      it 'returns the at-prefixed username' do
        expect(account.prefixed_pretty_acct).to eq('@username')
      end
    end
    ...
    context 'with a remote account' do
      ...
      it 'returns the at-prefixed username and domain' do
        expect(account.prefixed_pretty_acct).to eq('@username@host.example')
      end
    end
  end
