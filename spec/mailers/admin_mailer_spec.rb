  ...
  describe '.new_report' do
    ...
    it 'renders the email' do
      expect(mail)
        ...
        .and(have_subject("New report for mastodon.example (##{report.id})"))
        .and(have_body_text("Mike,\r\n\r\nJohn has reported Mike\r\n\r\nView: https://mastodon.example/admin/reports/#{report.id}\r\n"))
    end
  end
  ...
  describe '.new_appeal' do
    ...
    it 'renders the email' do
      expect(mail)
        ...
        .and(deliver_to(recipient.user_email))
        .and(deliver_from('notifications@localhost'))
        .and(have_subject("#{appeal.account.username} is appealing a moderation decision on mastodon.example"))
  ...
  describe '.new_pending_account' do
    ...
    it 'renders the email' do
      expect(mail)
        ...
        .and(deliver_to(recipient.user_email))
        .and(deliver_from('notifications@localhost'))
        .and(have_subject("New account up for review on mastodon.example (#{user.account.username})"))
  ...
  describe '.new_trends' do
    ...
    it 'renders the email' do
      expect(mail)
        ...
        .and(deliver_to(recipient.user_email))
        .and(deliver_from('notifications@localhost'))
        .and(have_subject('New trends up for review on mastodon.example'))
  ...
  describe '.new_software_updates' do
    ...
    it 'renders the email' do
      expect(mail)
        ...
        .and(deliver_to(recipient.user_email))
        .and(deliver_from('notifications@localhost'))
        .and(have_subject('New Mastodon versions are available for mastodon.example!'))
  ...
  describe '.new_critical_software_updates' do
    ...
    it 'renders the email' do
      expect(mail)
        ...
        .and(deliver_to(recipient.user_email))
        .and(deliver_from('notifications@localhost'))
        .and(have_subject('Critical Mastodon updates are available for mastodon.example!'))
