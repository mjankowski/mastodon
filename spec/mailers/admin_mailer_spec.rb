  ...
  describe '.new_report' do
    ...
    it 'renders the email' do
      expect(mail)
        ...
        .and(have_subject("New report for localhost:3000 (##{report.id})"))
        .and(have_body_text("Mike,\r\n\r\nJohn has reported Mike\r\n\r\nView: http://localhost:3000/admin/reports/#{report.id}\r\n"))
    end
  end
  ...
  describe '.new_appeal' do
    ...
    it 'renders the email' do
      expect(mail)
        ...
        .and(deliver_to(recipient.user_email))
        .and(deliver_from('notifications@localhost'))
        .and(have_subject("#{appeal.account.username} is appealing a moderation decision on localhost:3000"))
  ...
  describe '.new_pending_account' do
    ...
    it 'renders the email' do
      expect(mail)
        ...
        .and(deliver_to(recipient.user_email))
        .and(deliver_from('notifications@localhost'))
        .and(have_subject("New account up for review on localhost:3000 (#{user.account.username})"))
  ...
  describe '.new_trends' do
    ...
    it 'renders the email' do
      expect(mail)
        ...
        .and(deliver_to(recipient.user_email))
        .and(deliver_from('notifications@localhost'))
        .and(have_subject('New trends up for review on localhost:3000'))
  ...
  describe '.new_software_updates' do
    ...
    it 'renders the email' do
      expect(mail)
        ...
        .and(deliver_to(recipient.user_email))
        .and(deliver_from('notifications@localhost'))
        .and(have_subject('New Mastodon versions are available for localhost:3000!'))
  ...
  describe '.new_critical_software_updates' do
    ...
    it 'renders the email' do
      expect(mail)
        ...
        .and(deliver_to(recipient.user_email))
        .and(deliver_from('notifications@localhost'))
        .and(have_subject('Critical Mastodon updates are available for localhost:3000!'))
  ...
  describe '.auto_close_registrations' do
    ...
    it 'renders the email' do
      expect(mail)
        ...
        .and(deliver_to(recipient.user_email))
        .and(deliver_from('notifications@localhost'))
        .and(have_subject('Registrations for localhost:3000 have been automatically switched to requiring approval'))
